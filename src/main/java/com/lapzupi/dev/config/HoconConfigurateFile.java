 ...
 * @author sarhatabaot
 */
public abstract class HoconConfigurateFile <T extends JavaPlugin> extends CommentedConfigurateFile<T, @NotNull HoconConfigurationLoader, HoconConfigurationLoader.Builder> {

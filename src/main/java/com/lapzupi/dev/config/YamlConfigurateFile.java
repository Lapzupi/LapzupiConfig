 ...
 * @author sarhatabaot
 */
public abstract class YamlConfigurateFile<T extends JavaPlugin> extends CommentedConfigurateFile<T, @NotNull YamlConfigurationLoader, YamlConfigurationLoader.Builder> {
